...
class Account {
	...
	void deposit(int money) {
		//별도의 제한이 없으므로 잔고에 합산
		balance += money;
		System.out.println(money+"원이 입금");
	}
...
public class E04AccountMain {
	...
	public static void main(String[] args) {
		...
		/*
		 멤버변수를 직접 기술하는 것은 초기화 메소드에 비해 불편한 방법이므로 첫번째 방법으로 초기화하는 것이 좋다
		 */
