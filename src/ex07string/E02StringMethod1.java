...
public class E02StringMethod1 {
	...
	public static void main(String[] args) {
		...
		// 					앞문자의 아스키코드가 크면 양수를 반환하고 뒷문자의 아스키코드가 크면 음수를 반환
		//					두 문자열이 같을 때 0을 반환
		System.out.println("### 3 ###");
		String str3 = "A";
		String str4 = "B";
		System.out.println(str3.compareTo(str4)); //-1
		System.out.println(str4.compareTo(str3)); // 10
		System.out.println("ABC".compareTo("ABC")== 0 ? "문자열이 같아" : "문자열이 달라");
		
		// 4] concat() : 두개의 문자열을 연결, print()문에서 +와 동일한 역할
		System.out.println("### 4 ###");
		System.out.println("JAVA".concat(" WORLD").concat(" GO"));
		System.out.println("JAVA" +" WORLD"+ " GO");
		
		// 5] contains() : 문자열에 특정 문자열이 포함되어있는지 판단하여 포함되었다면 true 반환
