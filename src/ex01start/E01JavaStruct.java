...
//2. 임포트 선언부 : 프러그램에서 사용하는 클래스를 가져와서 사용할때 기술한다. 
//3. 클래스 선언부 : 프로그램의 주 내용응 입력한다.
...
//이클립스의 자동완선(COntent Assist) 기능을 통해 자동으로 입력된다.
//하단의 클래스 선언부는 우리가 구현할 기능에 대한 코드를 직접 작성한다.

public class E01JavaStruct {
	public static void main(String[] args) {
		Date toDayOfDate = new Date(); //시스템에서 현재 시간을 가져온다.
