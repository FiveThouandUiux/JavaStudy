...
class PersonalInfoDTO {
	...
	/*
	 getter / setter 메소드 정의 : private으로 정의된 멤버변수를 설정하거나 값을 반환받기 위해 생성
	 */
...
class PersonalNumberStorageExt extends PersonalNumberStorageAbs {
	...
	/*
	 추상메소드를 오버라이딩한 후 재정의
	 주민번호와 이름을 인매개변수로 받은 후 DTO인스턴스를 배열에 추가
	 */
	@Override
