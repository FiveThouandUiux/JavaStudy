...
//		buyer.buyApple(seller2, 5000);
		///////////////////////////////////////////////
		/*
		 아래 코드는 문법적으로는 오류가 없으나 지불금액과 구매한 사과의 관계가 전혀 맞지 않는 논리적 오류가 발생
		 코드(메소드)로 구현한 규칙이 완전히 무너지게 된다
		 객체지향 프로그래밍에서는 이런 오류를 막기위해 멤버변수에 대한 "정보은닉"을 권장
		 멤버변수의 외부 접근을 원천적으로 차단하고, 멤버 메소드를 통해서만 접근하게 하여 논리적 오류를 차단하는 것이 목적
		 */
