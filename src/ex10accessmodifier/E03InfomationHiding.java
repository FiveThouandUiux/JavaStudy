...
class FruitSeller6 {
	/*
	 멤버 변수에 private 접근지정자를 추가
	 이렇게하면 클래스 내부에서만 접근할 수 잇고 외부에서의 접근은 원천적으로 차단
	 */
...
public class E03InfomationHiding {
	...
	public static void main(String[] args) {
		...
		/*
		 각 판매자에게 1000원씩 지불하고 사과를 구매
		 멤버 메소드를 통한 구매이므로 판매의 규칙이 잘 지켜지케된다
		 이와같은 이유로 객체지향 프로그래밍에서는 "정보은닉"을 권장
		 */
